...
from base_utils.qwen_pipeline import QwenImageEditPlusPipeline
class Controller():
...
def main() :
    ...
    # processor = module.processor # QwenDoubleStreamAttnProcessor2_0
    import csv
    ...
    save_edit_folder = '/MIR/nas1/dreamyou070/Project/Project_EDIF/Zeroing/Zeroing_Experiment_Qwen/text_zeroing'
    ...
    for data in contents:
        ...
        if task == 'global' or task == 'style' or task == 'background' and not os.path.exists(unique_folder) :
            ...
            for target_block_idx in range(60) :
                ...
                save_dir = os.path.join(unique_folder, f'text_{target_block_idx}_zeroing.png')
            ...
            for target_block_idx in range(60):
                ...
                edut_result.save(os.path.join(unique_folder, f'text_non_zeroing.png'))
