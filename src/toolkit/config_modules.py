...
class TrainConfig:
    def __init__(self, **kwargs):
        ...
        self.w_main = kwargs.get('w_main',1)
        self.w_reg = kwargs.get('w_reg', 300)
...
class DatasetConfig:
    ...
    def __init__(self, **kwargs):
        ...
        self.src_folder = kwargs.get('src_folder', None)
        self.inst_folder = kwargs.get('inst_folder', None)
        self.result_folder = kwargs.get('result_folder', None)
        self.file_idx = int(kwargs.get('file_idx', None))
        self.filename = kwargs.get('filename', None)

        self.min_num = int(kwargs.get('min_num', 0))
        self.max_num = int(kwargs.get('max_num', 0))
        self.folder_path: str = kwargs.get('folder_path', None)
        self.data = kwargs.get('data', 'HQ')
        ...
        self.stage_1 = kwargs.get('stage_1', None)
...
def preprocess_dataset_raw_config(raw_config: List[dict]) -> List[dict]:
    ...
    for dataset in raw_config:
        ...
        res = dataset.get('resolution', 512)
