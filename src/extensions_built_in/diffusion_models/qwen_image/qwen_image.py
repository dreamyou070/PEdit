...
from .vae_model import AutoencoderKLQwenImage
# ---------------------------------------------------------
from .qwen_pipeline import QwenImageEditPlusPipeline as QwenImagePipeline
# ---------------------------------------------------------
...
class QwenImageModel(BaseModel):
    ...
    def load_model(self):
        ...
        if self.model_config.layer_offloading and self.model_config.layer_offloading_transformer_percent > 0:
            MemoryManager.attach(transformer,
                self.device_torch,offload_percent=self.model_config.layer_offloading_transformer_percent
            )
        ...
        print(f' Make PipelineHere ')
        from .qwen_pipeline import QwenImageEditPlusPipeline
